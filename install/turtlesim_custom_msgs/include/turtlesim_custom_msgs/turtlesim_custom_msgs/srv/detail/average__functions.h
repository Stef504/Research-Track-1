...
#ifndef TURTLESIM_CUSTOM_MSGS__SRV__DETAIL__AVERAGE__FUNCTIONS_H_
#define TURTLESIM_CUSTOM_MSGS__SRV__DETAIL__AVERAGE__FUNCTIONS_H_
 ...
 * )) before or use
 * turtlesim_custom_msgs__srv__Average_Request__create()
 ...
 * calls
 * turtlesim_custom_msgs__srv__Average_Request__init().
...
/**
 * It calls
 * turtlesim_custom_msgs__srv__Average_Request__fini()
 ...
 * turtlesim_custom_msgs__srv__Average_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * turtlesim_custom_msgs__srv__Average_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * turtlesim_custom_msgs__srv__Average_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_custom_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtlesim_custom_msgs__srv__Average_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_custom_msgs
...
/**
 * It calls
 * turtlesim_custom_msgs__srv__Average_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_custom_msgs
...
/**
 * It allocates the memory for the array and calls
 * turtlesim_custom_msgs__srv__Average_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_custom_msgs
...
/**
 * It calls
 * turtlesim_custom_msgs__srv__Average_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * turtlesim_custom_msgs__srv__Average_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_custom_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtlesim_custom_msgs__srv__Average_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_custom_msgs
...
/**
 * It calls
 * turtlesim_custom_msgs__srv__Average_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_custom_msgs
...
/**
 * It allocates the memory for the array and calls
 * turtlesim_custom_msgs__srv__Average_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_custom_msgs
...
/**
 * It calls
 * turtlesim_custom_msgs__srv__Average_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TURTLESIM_CUSTOM_MSGS__SRV__DETAIL__AVERAGE__FUNCTIONS_H_
