...
static const _Vel_type_support_symbol_names_t _Vel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_custom_msgs, msg, Vel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_custom_msgs, msg, Vel)),
  }
};
...
get_message_type_support_handle<turtlesim_custom_msgs::msg::Vel>()
{
  return &::turtlesim_custom_msgs::msg::rosidl_typesupport_cpp::Vel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_custom_msgs, msg, Vel)() {
  return get_message_type_support_handle<turtlesim_custom_msgs::msg::Vel>();
}
