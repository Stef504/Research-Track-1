...
bool turtlesim_custom_msgs__msg__vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * turtlesim_custom_msgs__msg__vel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlesim_custom_msgs.msg._vel");
