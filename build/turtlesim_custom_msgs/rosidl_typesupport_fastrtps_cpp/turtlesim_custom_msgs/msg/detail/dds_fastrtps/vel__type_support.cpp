...
#include "turtlesim_custom_msgs/msg/detail/vel__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const turtlesim_custom_msgs::msg::Vel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_custom_msgs::msg::Vel *>(
    untyped_ros_message);
...
{
  return &turtlesim_custom_msgs::msg::typesupport_fastrtps_cpp::_Vel__handle;
}
