...
#include "turtlesim_custom_msgs/msg/detail/vel__rosidl_typesupport_fastrtps_c.h"
...
using _Vel__ros_msg_type = turtlesim_custom_msgs__msg__Vel;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const turtlesim_custom_msgs__msg__Vel * ros_message = static_cast<const turtlesim_custom_msgs__msg__Vel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_turtlesim_custom_msgs__msg__Vel(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim_custom_msgs__msg__Vel * ros_message = static_cast<turtlesim_custom_msgs__msg__Vel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_turtlesim_custom_msgs__msg__Vel(cdr, ros_message);
}

static uint32_t _Vel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlesim_custom_msgs__msg__Vel(
...
static size_t _Vel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlesim_custom_msgs__msg__Vel(
