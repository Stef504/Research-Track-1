...
static const _Vel_type_support_symbol_names_t _Vel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_custom_msgs, msg, Vel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_custom_msgs, msg, Vel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_custom_msgs, msg, Vel)() {
  return &::turtlesim_custom_msgs::msg::rosidl_typesupport_c::Vel_message_type_support_handle;
}
