...
// IWYU pragma: private, include "robot_custom_msgs/srv/velocity.h"


#ifndef ROBOT_CUSTOM_MSGS__SRV__DETAIL__VELOCITY__FUNCTIONS_H_
#define ROBOT_CUSTOM_MSGS__SRV__DETAIL__VELOCITY__FUNCTIONS_H_
 ...
 * )) before or use
 * robot_custom_msgs__srv__Velocity_Request__create()
 ...
 * calls
 * robot_custom_msgs__srv__Velocity_Request__init().
...
/**
 * It calls
 * robot_custom_msgs__srv__Velocity_Request__fini()
 ...
 * robot_custom_msgs__srv__Velocity_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robot_custom_msgs__srv__Velocity_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * robot_custom_msgs__srv__Velocity_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_custom_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_custom_msgs__srv__Velocity_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_custom_msgs
...
/**
 * It calls
 * robot_custom_msgs__srv__Velocity_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_custom_msgs
...
/**
 * It allocates the memory for the array and calls
 * robot_custom_msgs__srv__Velocity_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_custom_msgs
...
/**
 * It calls
 * robot_custom_msgs__srv__Velocity_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * robot_custom_msgs__srv__Velocity_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_custom_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_custom_msgs__srv__Velocity_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_custom_msgs
...
/**
 * It calls
 * robot_custom_msgs__srv__Velocity_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_custom_msgs
...
/**
 * It allocates the memory for the array and calls
 * robot_custom_msgs__srv__Velocity_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_custom_msgs
...
/**
 * It calls
 * robot_custom_msgs__srv__Velocity_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_CUSTOM_MSGS__SRV__DETAIL__VELOCITY__FUNCTIONS_H_
