...
bool robot_custom_msgs__msg__custom__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_custom_msgs.msg._custom.Custom", full_classname_dest, 36) == 0);
  }
  robot_custom_msgs__msg__Custom * ros_message = _ros_message;
  {  // distance
...
PyObject * robot_custom_msgs__msg__custom__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_custom_msgs.msg._custom");
