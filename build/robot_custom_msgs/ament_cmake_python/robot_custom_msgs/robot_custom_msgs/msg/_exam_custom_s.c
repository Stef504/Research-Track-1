...
bool robot_custom_msgs__msg__exam_custom__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_custom_msgs.msg._exam_custom.ExamCustom", full_classname_dest, 45) == 0);
  }
  robot_custom_msgs__msg__ExamCustom * ros_message = _ros_message;
  {  // linear_velocity
...
{
  /* NOTE(esteve): Call constructor of ExamCustom */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_custom_msgs.msg._exam_custom");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExamCustom");
