...
#include "robot_custom_msgs/srv/detail/velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_custom_msgs::srv::Velocity_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_custom_msgs::srv::Velocity_Request & ros_message)
{
  // Member: min
  cdr >> ros_message.min;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_custom_msgs::srv::Velocity_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_custom_msgs::srv::Velocity_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_custom_msgs::srv::Velocity_Request *>(
    untyped_ros_message);
...
{
  return &robot_custom_msgs::srv::typesupport_fastrtps_cpp::_Velocity_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_custom_msgs, srv, Velocity_Request)() {
  return &robot_custom_msgs::srv::typesupport_fastrtps_cpp::_Velocity_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_custom_msgs
cdr_serialize(
  const robot_custom_msgs::srv::Velocity_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: x
  cdr << ros_message.x;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_custom_msgs::srv::Velocity_Response & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_custom_msgs::srv::Velocity_Response;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const robot_custom_msgs::srv::Velocity_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_custom_msgs::srv::Velocity_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robot_custom_msgs::srv::typesupport_fastrtps_cpp::_Velocity_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_custom_msgs, srv, Velocity_Response)() {
  return &robot_custom_msgs::srv::typesupport_fastrtps_cpp::_Velocity_Response__handle;
}
...
// functions for robot_custom_msgs::srv::Velocity_Request already declared above

// functions for robot_custom_msgs::srv::Velocity_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_custom_msgs
cdr_serialize(
  const robot_custom_msgs::srv::Velocity_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_custom_msgs::srv::Velocity_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_custom_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_Velocity_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_custom_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_Velocity_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_custom_msgs::srv::Velocity_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_custom_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Velocity_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_custom_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Velocity_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const robot_custom_msgs::srv::Velocity_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_custom_msgs::srv::Velocity_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robot_custom_msgs::srv::typesupport_fastrtps_cpp::_Velocity_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_custom_msgs, srv, Velocity_Event)() {
  return &robot_custom_msgs::srv::typesupport_fastrtps_cpp::_Velocity_Event__handle;
}
...
static const rosidl_service_type_support_t _Velocity__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<robot_custom_msgs::srv::Velocity_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<robot_custom_msgs::srv::Velocity_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<robot_custom_msgs::srv::Velocity_Event>(),
...
{
  return &robot_custom_msgs::srv::typesupport_fastrtps_cpp::_Velocity__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_custom_msgs, srv, Velocity)() {
  return &robot_custom_msgs::srv::typesupport_fastrtps_cpp::_Velocity__handle;
}
