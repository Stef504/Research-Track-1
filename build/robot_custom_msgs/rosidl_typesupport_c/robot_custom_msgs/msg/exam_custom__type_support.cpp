...
static const _ExamCustom_type_support_symbol_names_t _ExamCustom_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_custom_msgs, msg, ExamCustom)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_custom_msgs, msg, ExamCustom)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_custom_msgs, msg, ExamCustom)() {
  return &::robot_custom_msgs::msg::rosidl_typesupport_c::ExamCustom_message_type_support_handle;
}
