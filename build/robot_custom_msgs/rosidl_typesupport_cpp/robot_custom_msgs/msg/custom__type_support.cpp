...
static const _Custom_type_support_symbol_names_t _Custom_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_custom_msgs, msg, Custom)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_custom_msgs, msg, Custom)),
  }
};
...
{
  return &::robot_custom_msgs::msg::rosidl_typesupport_cpp::Custom_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_custom_msgs, msg, Custom)() {
  return get_message_type_support_handle<robot_custom_msgs::msg::Custom>();
}
