...
#include "robot_custom_msgs/msg/detail/exam_custom__rosidl_typesupport_fastrtps_c.h"
...
using _ExamCustom__ros_msg_type = robot_custom_msgs__msg__ExamCustom;
...
{
  const _ExamCustom__ros_msg_type * ros_message = static_cast<const _ExamCustom__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_custom_msgs__msg__ExamCustom;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robot_custom_msgs__msg__ExamCustom * ros_message = static_cast<const robot_custom_msgs__msg__ExamCustom *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robot_custom_msgs__msg__ExamCustom(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robot_custom_msgs__msg__ExamCustom * ros_message = static_cast<robot_custom_msgs__msg__ExamCustom *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robot_custom_msgs__msg__ExamCustom(cdr, ros_message);
}

static uint32_t _ExamCustom__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_custom_msgs__msg__ExamCustom(
...
static size_t _ExamCustom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_custom_msgs__msg__ExamCustom(
...
static message_type_support_callbacks_t __callbacks_ExamCustom = {
...
static rosidl_message_type_support_t _ExamCustom__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ExamCustom,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_custom_msgs, msg, ExamCustom)() {
  return &_ExamCustom__type_support;
}
