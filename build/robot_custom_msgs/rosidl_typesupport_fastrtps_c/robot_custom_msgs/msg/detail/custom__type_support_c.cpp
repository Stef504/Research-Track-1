...
#include "robot_custom_msgs/msg/detail/custom__rosidl_typesupport_fastrtps_c.h"
...
using _Custom__ros_msg_type = robot_custom_msgs__msg__Custom;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_custom_msgs__msg__Custom;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robot_custom_msgs__msg__Custom * ros_message = static_cast<const robot_custom_msgs__msg__Custom *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robot_custom_msgs__msg__Custom(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robot_custom_msgs__msg__Custom * ros_message = static_cast<robot_custom_msgs__msg__Custom *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robot_custom_msgs__msg__Custom(cdr, ros_message);
}

static uint32_t _Custom__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_custom_msgs__msg__Custom(
...
static size_t _Custom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_custom_msgs__msg__Custom(
