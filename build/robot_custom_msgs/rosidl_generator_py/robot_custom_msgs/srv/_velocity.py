...
class Velocity_Event(metaclass=Metaclass_Velocity_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robot_custom_msgs/Velocity_Request, 1>',
        'response': 'sequence<robot_custom_msgs/Velocity_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_custom_msgs', 'srv'], 'Velocity_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_custom_msgs', 'srv'], 'Velocity_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robot_custom_msgs.srv import Velocity_Request
    ...
    def response(self, value):
        if self._check_fields:
            from robot_custom_msgs.srv import Velocity_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Velocity(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_custom_msgs.srv.Velocity')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_custom_msgs.srv import _velocity
...
class Velocity(metaclass=Metaclass_Velocity):
    from robot_custom_msgs.srv._velocity import Velocity_Request as Request
    from robot_custom_msgs.srv._velocity import Velocity_Response as Response
    from robot_custom_msgs.srv._velocity import Velocity_Event as Event
