...
#define NODE_MAIN_LOGGER_NAME "cancel_client_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcancel_client.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<tutorial_1_action_cpp::RobotActionCancelClient>";
