...
#define NODE_MAIN_LOGGER_NAME "server_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libserver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<tutorial_1_action_cpp::RobotActionServer>";
