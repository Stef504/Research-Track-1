...
#define NODE_MAIN_LOGGER_NAME "talker_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtalker_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<first_package_cpp::MinimalPublisher>";
