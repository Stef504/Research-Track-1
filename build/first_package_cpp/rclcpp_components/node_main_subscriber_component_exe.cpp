...
#define NODE_MAIN_LOGGER_NAME "subscriber_component_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsubscriber_component2.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<first_package_cpp::MinimalSubscriber_component>";
